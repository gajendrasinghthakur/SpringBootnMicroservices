...
/**
 * NbaCommissionTargetPremiumCalculator
 * <p>
...
public class NbaCommissionTargetPremiumCalculator extends NbaContractCalculatorCommon implements NbaContractCalculator{

	/**
	 * Constructor for NbaCommissionTargetPremiumCalculator. 
	 * @param aCalcType
	 * @param aNbaTxLife
	 * @throws NbaBaseException
	 */
	public NbaCommissionTargetPremiumCalculator(String aCalcType, NbaTXLife aNbaTxLife) throws NbaBaseException {
		super(aCalcType, aNbaTxLife);
	}
	/**
	 * Performs the calculation integration for Commission Target Premium Load for a contract.
	...
	public NbaCalculation calculate() throws NbaBaseException, NbaVpmsException {
		try {
			if (noModelForCalc()) {
				...
				setDynamicAttribute(ATR_CALLING_PROGRAM, NbaCommissionTargetPremiumCalculator.class.getName());
	...
	/**
	 * Perform the commission target premium load target calculations for base policy.
	 */
