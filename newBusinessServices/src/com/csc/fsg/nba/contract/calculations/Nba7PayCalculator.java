 ...
 */
public class Nba7PayCalculator extends NbaContractCalculatorCommon implements NbaContractCalculator {
	/**
	 * Constructor for Nba7PayCalculator.
	 * @param aCalcType
	 * @param aNbaTxLife
	 * @throws NbaBaseException
	 */
	public Nba7PayCalculator(String aCalcType, NbaTXLife aNbaTxLife) throws NbaBaseException {
	...
	public NbaCalculation calculate() throws NbaBaseException, NbaVpmsException {
		try {
			if (noModelForCalc()) {
				...
				setDynamicAttribute(ATR_CALLING_PROGRAM, Nba7PayCalculator.class.getName());
