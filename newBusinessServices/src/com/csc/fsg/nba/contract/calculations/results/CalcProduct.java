...
public class CalcProduct
	 ...
	 */
	public CalcProduct (XmlElement xml) {
		unmarshal(xml);
	}
	 ...
	 */
	public CalcProduct (XmlElement xml, XmlObject parent) {
		_parent_ = parent;
		unmarshal(xml);
	}
	...
	protected String _node_name_ = $CALC_PRODUCT;
	...
	public static boolean matches (XmlElement xml, XmlObject parent) {
		...
		return (xml.matches($CALC_PRODUCT, nsm, parent));
	}
	 ...
	 */
	public static CalcProduct unmarshal (
			InputStream in) throws Exception {

		CalcProduct obj = new CalcProduct();
	...
	public void unmarshal (XmlElement xml) {
		...
		if (!xml.matches($CALC_PRODUCT, this)) {
			return;
		}
