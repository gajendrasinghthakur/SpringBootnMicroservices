...
public class ObjectFactory extends XmlObjectFactory {
	...
	static {
		...
		_default_map.put("NbaCalculation",
			"com.csc.fsg.nba.contract.calculations.results.NbaCalculation");
		_default_map.put("CalculationResult",
			"com.csc.fsg.nba.contract.calculations.results.CalculationResult");
		_default_map.put("CalcProduct",
			"com.csc.fsg.nba.contract.calculations.results.CalcProduct");
		_default_map.put("CalcError",
			"com.csc.fsg.nba.contract.calculations.results.CalcError");
	}
