...
public class CalcResult
	...
	/**
	 * Constant for "objecId" node name.
	 */
	public static final String $OBJEC_ID = "objecId";
	 ...
	 */
	protected java.util.Vector _Result = new java.util.Vector(4, 0);
	protected String _ObjecId = null;
	 ...
	 */
	public CalcResult (XmlElement xml) {
		unmarshal(xml);
	}
	 ...
	 */
	public CalcResult (XmlElement xml, XmlObject parent) {
		_parent_ = parent;
		unmarshal(xml);
	}
	...
	public Result getResultAt (int index)
		...
		return ((Result)_Result.elementAt(index));
	}


	/**
	 * Get the count of elements in the Result property.
	 */
	 ...
	 */
	public void setResult (java.util.Vector newList) {

		if (newList == null) {
			_Result.removeAllElements();
		} else {
			_Result = (java.util.Vector)newList.clone();
		}
	}
	...
	public void addResult (Result obj) {
		...
		_Result.addElement(obj);
	}


	public void setResultAt (Result obj, int index)
			throws IndexOutOfBoundsException {
		if (obj == null) {
			return;
		}

		_Result.setElementAt(obj, index);
	}


	public void removeResult (Result obj) {
		if (obj == null) {
			return;
		}

		_Result.removeElement(obj);
	}


	public void removeResultAt (int index)
			throws IndexOutOfBoundsException {
		_Result.removeElementAt(index);
	}


	private void setResult (XmlElement xml) {

		_Result.removeAllElements();
		XmlElement saved_xml = xml;

		while (xml != null &&
			Result.matches(xml, this)) {
			Object obj = new Result(xml, this);
			_Result.addElement(obj);
	...
	/**
	 * Set the ObjecId property.
	 */
	public void setObjecId (String newValue) {
		_ObjecId = newValue;
	}


	/**
	 * Checks for whether ObjecId is set or not.
	 *
	 * @return true if ObjecId is set, false if not
	 */
	 public boolean hasObjecId () {
		return (_ObjecId != null);
	}


	/**
	 * Discards ObjecId's value.
	 */
	 public void deleteObjecId () {
		_ObjecId = null;
	}


	protected String _node_name_ = $CALC_RESULT;
	...
	protected static synchronized void createValidators () {
		...
		_Result_validator_ = new XmlValidator(
			"CalcResult.Result", "Element", 
			"CalcResult/Result", 0, -1);
	...
	public java.util.Vector getValidationErrors (
		...
		is_valid = _Result_validator_.isValid(
			_Result,
	...
	public static boolean matches (XmlElement xml, XmlObject parent) {
		...
		return (xml.matches($CALC_RESULT, nsm, parent));
	}
	 ...
	 */
	public static CalcResult unmarshal (
			InputStream in) throws Exception {

		CalcResult obj = new CalcResult();
	...
	public void unmarshal (XmlElement xml) {
		...
		if (!xml.matches($CALC_RESULT, this)) {
			return;
		}
	...
	protected void unmarshalAttributes (XmlElement xml) {
		 ...
		 */
		setObjecId(xml.getAttribute($OBJEC_ID, this));
	}
