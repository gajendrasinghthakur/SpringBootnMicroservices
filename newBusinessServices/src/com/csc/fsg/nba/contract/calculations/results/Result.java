...
public class Result
	 ...
	 */
	public Result (XmlElement xml, XmlObject parent) {
		_parent_ = parent;
		unmarshal(xml);
	}
	...
	protected String _node_name_ = $RESULT;
	...
	public static boolean matches (XmlElement xml, XmlObject parent) {
		...
		return (xml.matches($RESULT, nsm, parent));
	}
	 ...
	 */
	public static Result unmarshal (
