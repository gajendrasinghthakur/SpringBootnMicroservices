...
/**
 * InforcePaymentWebProxy is the class which makes a call to the Inforce Payment Webservice.
 * It passes the request xml received from client to webservice and gets the response xml back
 * from webservice. After getting the response, this class returns the response to client class.
 * <p>
...
public class InforcePaymentWebProxy
{
  private Call call;
  private URL url = null;
  private String stringURL = "http://danbant06:9081/lifews/services/Tx508";
  private java.lang.reflect.Method setTcpNoDelayMethod;
  private NbaTXLife txLifeInforcePaymentResp = null;
  private static NbaLogger logger = null; //NBA108 NBA109
  private String timeout = null;//NBA108 NBA109
 
  public InforcePaymentWebProxy()
  {
    try
    {
    ...
    {
		if (getLogger().isErrorEnabled()){ //NBA108 NBA109
		   getLogger().logError(e);   //NBA108 NBA109
		}	//NBA108 NBA109
    }
    call = createCall();
  }
  ...
  public synchronized org.w3c.dom.Element service(org.w3c.dom.Element part) throws Exception
  {
	...
	SOAPHTTPConnection soapHTTPConnection = new SOAPHTTPConnection();//NBA108 NBA109

    if(getURL() == null)
    {
      throw new SOAPException(Constants.FAULT_CODE_CLIENT,
      "A URL must be specified via InforcePaymentWebProxy.setEndPoint(URL).");
    }
    ...
    try{
    	...
    	if(getLogger().isFatalEnabled()){
    		getLogger().logFatal("Payments WebService Timed-out: ");
  ...
  protected Call createCall()
  {
    ...
    if ( setTcpNoDelayMethod != null)
    {
      ...
      {
		if (getLogger().isErrorEnabled()){ //NBA108 NBA109
		   getLogger().logError(ex);   //NBA108 NBA109
		}	//NBA108 NBA109
      }
    }
    Call call = new Call();
	...
	//NBA108 NBA109 two methods deleted
	...
	private static NbaLogger getLogger() {
		if (logger == null) {
			try {
				logger = NbaLogFactory.getLogger(InforcePaymentWebProxy.class.getName());
			} catch (Exception e) {
