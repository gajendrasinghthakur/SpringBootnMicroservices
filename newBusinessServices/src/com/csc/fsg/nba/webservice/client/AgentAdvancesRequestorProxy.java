...
public class AgentAdvancesRequestorProxy {
	private Call call;
	private URL url = null;
	private String stringURL = "http://danbant06:9083/lifews/services/Tx103_1000500022";
	private java.lang.reflect.Method setTcpNoDelayMethod;
	private String timeout = "30000";
	private static NbaLogger logger = null;

	public AgentAdvancesRequestorProxy() {
		try {
	...
	public synchronized org.w3c.dom.Element service(org.w3c.dom.Element part) throws Exception {
		...
		if (getURL() == null) {
			throw new SOAPException(Constants.FAULT_CODE_CLIENT, "A URL must be specified via AgentAdvancesRequestorProxy.setEndPoint(URL).");
		}
	...
	private static NbaLogger getLogger() {
		if (logger == null) {
			try {
				...
				NbaBootLogger.log("AgentAdvancesRequestorProxy could not get a logger from the factory.");
