 ...
 * *******************************************************************************<BR>
 */
import com.csc.fsg.nba.backendadapter.cyberlifecalcs.NbaCyberCalculationAdapter;
...
/**
 * NbaCyberCalculationWebServiceClient is the client class to call nbA hosted CyberLife adapter for calculations.
 * <p>
 ...
 */
public class NbaCyberCalculationWebServiceClient extends NbaWebServiceAdapterBase {
    private NbaLogger logger;
	/**
	 * Constructor for NbaCyberCalculationWebServiceClient.
	 */
	public NbaCyberCalculationWebServiceClient() {
        super();
    }
	/**
	...
	public NbaTXLife invokeWebService(NbaTXLife nbATxLife) throws NbaBaseException {
	    ...
	    try {
            ...
            NbaCyberCalculationAdapter adapter = new NbaCyberCalculationAdapter();
            nbaTxlifeResponse = adapter.calculate(nbATxLife);
