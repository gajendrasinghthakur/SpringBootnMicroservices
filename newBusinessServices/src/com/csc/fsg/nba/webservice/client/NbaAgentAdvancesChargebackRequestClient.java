...
/**
* Client class for NbaAgentAdvancesChargebackRequest web service, It exposes method to process TXLife request and send TXLife response
...
*/
public class NbaAgentAdvancesChargebackRequestClient extends NbaWebServiceAdapterBase {

	public static final String FAULT_ELEMENT = "soapenv:Fault";
	/**
	 * This method invokes the Tx50500 web service for agent advances chargebacks
	 * @param nbATxLife Tx505 request
	 * @param object
	 * @return NbaTXLife Tx505 response from the webservice 
	 */
	public NbaTXLife invokeWebService(NbaTXLife nbATxLife) throws NbaBaseException {
		// SPR3290 code deleted
		NbaTXLife agentAdvancesChargebackResp = null;
		try {
		    AgentAdvancesChargebackRequestorProxy proxy = new AgentAdvancesChargebackRequestorProxy();
			...
			agentAdvancesChargebackResp = new NbaTXLife(NbaUtils.convertDOMElementToString(responseEle));
		} catch (Exception e) {
			throw new NbaBaseException(NbaBaseException.AGENT_WEBSERVICE_PROCESSING_ERROR, e, NbaExceptionType.FATAL);
		}
		return agentAdvancesChargebackResp;
	}
}
