...
public class ClientSearchWebProxy extends NbaWebServiceAdapterBase {

  private Call call;
  private URL url = null;
  private String stringURL = "http://ehrpsnt01:9082/lifews/services/ClientSearch";
  private java.lang.reflect.Method setTcpNoDelayMethod;
  private NbaTXLife txLifeClientSearchResp = null;
 
  public ClientSearchWebProxy()
  {
	try
	{
  ...
  public NbaTXLife invokeWebService(NbaTXLife nbATxLife) { // SPR2968
	  try {
		 ...
		 // call = createCall();
		  ...
		  txLifeClientSearchResp = new NbaTXLife(Element2String(responseEle));
		  
	  } catch (Exception e) {
	  }
	  return txLifeClientSearchResp;
  }
  ...
  public synchronized org.w3c.dom.Element service(org.w3c.dom.Element part) throws Exception
  {
	...
	if(getURL() == null)
	{
	  ...
	  "A URL must be specified via ClientSearchWebProxy.setEndPoint(URL).");
	}
