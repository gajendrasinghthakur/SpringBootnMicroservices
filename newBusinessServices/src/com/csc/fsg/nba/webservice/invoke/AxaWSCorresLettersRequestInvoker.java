 ...
 */
public class AxaWSCorresLettersRequestInvoker extends AxaWSInvokerBase {
	private static final String CATEGORY = "Correspondence";

	private static final String FUNCTIONID = "getListOfDocuments";
	 ...
	 * @param nbaTXLife
	 */
	public AxaWSCorresLettersRequestInvoker(String operation, NbaUserVO userVO, NbaTXLife nbaTXLife, NbaDst nbaDst, Object object) {
    ...
    public void invoke() throws NbaBaseException {
		...
		requestParams.put("categoryName", getObject() != null ? ((Map)getObject()).get("categoryName") : null);
        ...
        try {
        	setWebserviceResponse(results.get(WS_OP_CORRESPONDENCE_GETLETTERS_RETURN));
