 ...
 */
public class AxaWSCorresVariablesRequestInvoker extends AxaWSInvokerBase {
	private static final String CATEGORY = "Correspondence";

	private static final String FUNCTIONID = "getDocumentVariables";
	 ...
	 * @param nbaTXLife
	 */
	public AxaWSCorresVariablesRequestInvoker(String operation, NbaUserVO userVO, NbaTXLife nbaTXLife, NbaDst nbaDst, Object object) {
    ...
    public void invoke() throws NbaBaseException {
        ...
        try {
        	setWebserviceResponse(results.get(WS_OP_CORRESPONDENCE_GETVARIABLES_RETURN));
