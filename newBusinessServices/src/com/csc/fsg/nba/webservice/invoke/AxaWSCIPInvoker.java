...
public class AxaWSCIPInvoker extends AxaWSInvokerBase {

	private static final String CATEGORY = "CIP";

	private static final String FUNCTIONID = "retrieveCIData";
	 ...
	 * @param object
	 */
	public AxaWSCIPInvoker(String operation, NbaUserVO userVO, NbaTXLife nbaTXLife, NbaDst nbaDst, Object object) {
