 ...
 */
public class AxaWSCorresPDFRequestInvoker extends AxaWSInvokerBase {
	private static final String CATEGORY = "Correspondence";

	private static final String FUNCTIONID = "requestDocumentsWithData";
	 ...
	 * @param nbaTXLife
	 */
	public AxaWSCorresPDFRequestInvoker(String operation, NbaUserVO userVO, NbaTXLife nbaTXLife, NbaDst nbaDst, Object object) {
    ...
    public void invoke() throws NbaBaseException {
    	setReinsuranceCategory();//AXAL3.7.32 This is temporary method call. Should be removed once Axa is ready with reinsurance correspondence letter
		...
		requestParams.put("docName", getObject() != null ? ((Map)getObject()).get("docName") : null);
		requestParams.put("keysMap", getObject() != null ? ((Map)getObject()).get("keyMap") : null);
		requestParams.put("customerData", getObject() != null ? ((Map)getObject()).get("customerData") : null);
        ...
        try {
        	setWebserviceResponse(results.get(WS_OP_CORRESPONDENCE_GETPDF_RETURN));
    ...
    //AXAL3.7.32 This is temporary method. Should be removed once Axa is ready with reinsurance correspondence letter
    protected void setReinsuranceCategory() throws NbaBaseException {
    	...
    	if(letterName.equalsIgnoreCase((String)((Map)getObject()).get("docName"))) {
    		setCategory("Rein" + getCategory());
    	}
    }
}
