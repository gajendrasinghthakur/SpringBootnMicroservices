...
/**
 * This class is responsible for creating request for Compensation PIRS webservice .
 * <p>
...
public class AxaWSPIRSInvoker extends AxaWS1203Invoker {
	private static final String CATEGORY = "COMPENSATIONRETRIEVE";

	private static final String FUNCTIONID = "SubmitPIRequirementCompensation";
	 ...
	 * @param nbaTXLife
	 */
	public AxaWSPIRSInvoker(String operation, NbaUserVO userVO, NbaTXLife nbaTXLife, NbaDst nbaDst, Object object) {
