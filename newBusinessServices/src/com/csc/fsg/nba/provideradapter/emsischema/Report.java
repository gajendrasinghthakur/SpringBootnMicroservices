...
public class Report
	...
	/**
	 * Constant for "Full" node name.
	 */
	public static final String $FULL = "Full";

	/**
	 * Constant for "Speed" node name.
	 */
	public static final String $SPEED = "Speed";

	/**
	 * Constant for "CheckReq" node name.
	 */
	public static final String $CHECK_REQ = "CheckReq";


	/**
	 * Declarations for the XML related fields.
	 */
	protected String _CheckReq = null;
	protected int _Full = -1;
	protected boolean _has_Full_ = false;
	protected int _Speed = -1;
	protected boolean _has_Speed_ = false;
	 ...
	 */
	public Report (XmlElement xml, XmlObject parent) {
		_parent_ = parent;
		unmarshal(xml);
	}
	...
	/**
	 * Set the CheckReq property.
	 */
	public void setCheckReq (String newValue) {
		_CheckReq = newValue;
	}


	/**
	 * Checks for whether CheckReq is set or not.
	 *
	 * @return true if CheckReq is set, false if not
	 */
	 public boolean hasCheckReq () {
		return (_CheckReq != null);
	}


	/**
	 * Discards CheckReq's value.
	 */
	 public void deleteCheckReq () {
		_CheckReq = null;
	}
	 ...
	 */
	public void setFull (int new_value) {
		_Full = new_value;
		_has_Full_ = true;
		_format_errors.remove("Report.Full");
	}


	public void setFull (String new_value) {
		...
		try {
			_Full = Integer.parseInt(new_value);
			_has_Full_ = true;
			_format_errors.remove("Report.Full");
		} catch (NumberFormatException nfe) {
			_has_Full_ = false;
			XmlValidationError.addValidityFormatError(
				_format_errors, "Report.Full", "Element",
				"Report/Full", new_value);
		}
	}


	/**
	 * Checks for whether Full is set or not.
	 *
	 * @return true if Full is set, false if not
	 */
	...
	public void setSpeed (int new_value) {
		_Speed = new_value;
		_has_Speed_ = true;
		_format_errors.remove("Report.Speed");
	}


	public void setSpeed (String new_value) {
		...
		try {
			_Speed = Integer.parseInt(new_value);
			_has_Speed_ = true;
			_format_errors.remove("Report.Speed");
		} catch (NumberFormatException nfe) {
			_has_Speed_ = false;
			XmlValidationError.addValidityFormatError(
				_format_errors, "Report.Speed", "Element",
				"Report/Speed", new_value);
		}
	}


	/**
	 * Checks for whether Speed is set or not.
	 *
	 * @return true if Speed is set, false if not
	 */
	...
	protected String _node_name_ = $REPORT;
	...
	transient protected static XmlStringValidator 
		_CheckReq_validator_ = null;
	transient protected static XmlIntegerValidator
		_Full_validator_ = null;
	transient protected static XmlIntegerValidator
		_Speed_validator_ = null;
	...
	protected static synchronized void createValidators () {
		...
		_CheckReq_validator_ = new XmlStringValidator(
			"Report.CheckReq", "Element", 
			"Report/CheckReq", -1, -1, 1, 1);

		_Full_validator_ = new XmlIntegerValidator(
			"Report.Full", "Element",
			"Report/Full",
			0, XmlValidator.NOT_USED,
			0, XmlValidator.NOT_USED, 1, 1);

		_Speed_validator_ = new XmlIntegerValidator(
			"Report.Speed", "Element",
			"Report/Speed",
			0, XmlValidator.NOT_USED,
			0, XmlValidator.NOT_USED, 1, 1);
	...
	public java.util.Vector getValidationErrors (
		...
		e = _CheckReq_validator_.validate(
			_CheckReq);
		if (e != null) {
			errors.addElement(e);
			if (return_on_error) {
		...
		e = _Full_validator_.validate(
			_Full,
			_has_Full_, _format_errors);
		if (e != null) {
			errors.addElement(e);
			if (return_on_error) {
				return (errors);
		...
		e = _Speed_validator_.validate(
			_Speed,
			_has_Speed_, _format_errors);
		if (e != null) {
			errors.addElement(e);
			if (return_on_error) {
				return (errors);
	...
	public static boolean matches (XmlElement xml, XmlObject parent) {
		...
		return (xml.matches($REPORT, nsm, parent));
	}
	...
	public void unmarshal (XmlElement xml) {
		...
		if (xml.matches($CHECK_REQ, this)) {
			setCheckReq(xml.getData());
			xml = xml.next();
			if (xml == null) {
				return;
			}
		...
		if (xml.matches($SPEED, this)) {
			setSpeed(xml.getData());
			xml = xml.next();
			if (xml == null) {
				return;
			}
