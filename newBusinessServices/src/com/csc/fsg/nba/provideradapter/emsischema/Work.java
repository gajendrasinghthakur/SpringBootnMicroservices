...
public class Work
	 ...
	 */
	public Work (XmlElement xml, XmlObject parent) {
		_parent_ = parent;
		unmarshal(xml);
	}
	...
	public void setAreaCode (int new_value) {
		_AreaCode = new_value;
		_has_AreaCode_ = true;
		_format_errors.remove("Work.AreaCode");
	}
	...
	public void setAreaCode (String new_value) {
		...
		try {
			...
			XmlValidationError.addValidityFormatError(
				_format_errors, "Work.AreaCode", "Element",
				"Work/AreaCode", new_value);
		}
	}
	...
	public void setPrefix (int new_value) {
		_Prefix = new_value;
		_has_Prefix_ = true;
		_format_errors.remove("Work.Prefix");
	}
	...
	public void setPrefix (String new_value) {
		...
		try {
			...
			_has_Prefix_ = false;
			XmlValidationError.addValidityFormatError(
				_format_errors, "Work.Prefix", "Element",
				"Work/Prefix", new_value);
		}
	}
	...
	public void setSuffix (int new_value) {
		_Suffix = new_value;
		_has_Suffix_ = true;
		_format_errors.remove("Work.Suffix");
	}
	...
	public void setSuffix (String new_value) {
		...
		try {
			...
			_has_Suffix_ = false;
			XmlValidationError.addValidityFormatError(
				_format_errors, "Work.Suffix", "Element",
				"Work/Suffix", new_value);
		}
	}
	...
	protected String _node_name_ = $WORK;
	...
	protected static synchronized void createValidators () {
		...
		_Extension_validator_ = new XmlStringValidator(
			"Work.Extension", "Element", 
			"Work/Extension", -1, -1, 1, 1);
	...
	public static boolean matches (XmlElement xml, XmlObject parent) {
		...
		return (xml.matches($WORK, nsm, parent));
	}
