...
public class Location
	 ...
	 */
	public Location (XmlElement xml, XmlObject parent) {
		_parent_ = parent;
		unmarshal(xml);
	}
	 ...
	 * Set the Tc property.
	 */
	public void setTc (String newValue) {
		_Tc = newValue;
	}
	...
	protected String _node_name_ = $LOCATION;
	...
	public static boolean matches (XmlElement xml, XmlObject parent) {
		...
		return (xml.matches($LOCATION, nsm, parent));
	}
	 ...
	 */
	public static Location unmarshal (
