...
public class Carrier
	...
	/**
	 * Constant for "CarrierCode" node name.
	 */
	 ...
	 */
	protected String _CarrierCode = null;
	 ...
	 */
	public Carrier (XmlElement xml, XmlObject parent) {
		_parent_ = parent;
		unmarshal(xml);
	}
	...
	/**
	 * Set the CarrierCode property.
	 */
	public void setCarrierCode (String newValue) {
		_CarrierCode = newValue;
	}


	/**
	 * Checks for whether CarrierCode is set or not.
	 *
	 * @return true if CarrierCode is set, false if not
	 */
	 public boolean hasCarrierCode () {
		return (_CarrierCode != null);
	}


	/**
	 * Discards CarrierCode's value.
	 */
	 public void deleteCarrierCode () {
		_CarrierCode = null;
	}


	protected String _node_name_ = $CARRIER;
	...
	public java.util.Vector getValidationErrors (
		...
		e = _CarrierCode_validator_.validate(
			_CarrierCode);
		if (e != null) {
			errors.addElement(e);
			if (return_on_error) {
	...
	public static boolean matches (XmlElement xml, XmlObject parent) {
		...
		return (xml.matches($CARRIER, nsm, parent));
	}
	 ...
	 */
	public static Carrier unmarshal (
	...
	public void unmarshal (XmlElement xml) {
		...
		if (xml.matches($CARRIER_CODE, this)) {
			setCarrierCode(xml.getData());
			xml = xml.next();
			if (xml == null) {
				return;
			}
