...
public class Agent
	 ...
	 */
	public Agent (XmlElement xml, XmlObject parent) {
		_parent_ = parent;
		unmarshal(xml);
	}
	...
	protected String _node_name_ = $AGENT;
	...
	public static boolean matches (XmlElement xml, XmlObject parent) {
		...
		return (xml.matches($AGENT, nsm, parent));
	}
