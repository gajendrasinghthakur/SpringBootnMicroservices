...
import com.tbf.xml.XmlObjectFactory;
    ...
    public class ObjectFactory extends XmlObjectFactory {
    	...
    	static {
  		...
  		_default_map.put("EMSIAPSOrder",
 			"com.csc.fsg.nba.provideradapter.emsischema.Emsiapsorder"); 
 		_default_map.put("EMSIPHIOrder", 
  			"com.csc.fsg.nba.provideradapter.emsischema.Emsiphiorder");
    		_default_map.put("SourceInfo",
    			"com.csc.fsg.nba.provideradapter.emsischema.SourceInfo");
    		_default_map.put("Carrier",
    			"com.csc.fsg.nba.provideradapter.emsischema.Carrier");
    		_default_map.put("Applicant",
    			"com.csc.fsg.nba.provideradapter.emsischema.Applicant");
    		_default_map.put("Person",
    			"com.csc.fsg.nba.provideradapter.emsischema.Person");
    		_default_map.put("Address",
    			"com.csc.fsg.nba.provideradapter.emsischema.Address");
    		_default_map.put("Phone",
    			"com.csc.fsg.nba.provideradapter.emsischema.Phone");
    		_default_map.put("Work",
    			"com.csc.fsg.nba.provideradapter.emsischema.Work");
    		_default_map.put("Home",
    			"com.csc.fsg.nba.provideradapter.emsischema.Home");
    		_default_map.put("Policy",
    			"com.csc.fsg.nba.provideradapter.emsischema.Policy");
    		_default_map.put("Agent",
    			"com.csc.fsg.nba.provideradapter.emsischema.Agent");
 		_default_map.put("APS",
  			"com.csc.fsg.nba.provideradapter.emsischema.Aps");
  		_default_map.put("PHI",
  			"com.csc.fsg.nba.provideradapter.emsischema.Phi");
  		_default_map.put("ScannedAuthorization",
  			"com.csc.fsg.nba.provideradapter.emsischema.ScannedAuthorization");
  		_default_map.put("ScannedImage",
  			"com.csc.fsg.nba.provideradapter.emsischema.ScannedImage");
  		_default_map.put("Location",
  			"com.csc.fsg.nba.provideradapter.emsischema.Location");
 		_default_map.put("Report",
 			"com.csc.fsg.nba.provideradapter.emsischema.Report");
  		_default_map.put("Questionnaire",
  			"com.csc.fsg.nba.provideradapter.emsischema.Questionnaire");
    	}
