...
public class Emsiphiorder
	...
	/**
	 * Constant for "EMSIPHIOrder" node name.
	 */
	public static final String $EMSIPHIORDER = "EMSIPHIOrder";
	 ...
	 */
	public Emsiphiorder (XmlElement xml) {
		unmarshal(xml);
	}
	 ...
	 */
	public Emsiphiorder (XmlElement xml, XmlObject parent) {
		_parent_ = parent;
		unmarshal(xml);
	}
	 ...
	 */
	public void setPhi (Phi obj) {
		_Phi = obj;
	}


	private void setPhi (XmlElement xml) {
	...
	/**
	 * Checks for whether Phi is set or not.
	 *
	 * @return true if Phi is set, false if not
	 */
	...
	protected String _node_name_ = $EMSIPHIORDER;
	...
	protected static synchronized void createValidators () {
		...
		_SourceInfo_validator_ = new XmlValidator(
			"Emsiphiorder.SourceInfo", "Element", 
			"EMSIPHIOrder/SourceInfo", 1, 1);

		_Carrier_validator_ = new XmlValidator(
			"Emsiphiorder.Carrier", "Element", 
			"EMSIPHIOrder/Carrier", 1, 1);

		_Applicant_validator_ = new XmlValidator(
			"Emsiphiorder.Applicant", "Element", 
			"EMSIPHIOrder/Applicant", 1, 1);

		_Agent_validator_ = new XmlValidator(
			"Emsiphiorder.Agent", "Element", 
			"EMSIPHIOrder/Agent", 1, 1);

		_Phi_validator_ = new XmlValidator(
			"Emsiphiorder.Phi", "Element", 
			"EMSIPHIOrder/PHI", 1, 1);
	...
	public java.util.Vector getValidationErrors (
		...
		is_valid = _Phi_validator_.isValid(
			_Phi,
			errors, return_on_error, traverse);
		if (!is_valid && return_on_error) {
			return (errors);
	...
	public static boolean matches (XmlElement xml, XmlObject parent) {
		...
		return (xml.matches($EMSIPHIORDER, nsm, parent));
	}
	 ...
	 */
	public static Emsiphiorder unmarshal (
			InputStream in) throws Exception {

		Emsiphiorder obj = new Emsiphiorder();
	...
	public void unmarshal (XmlElement xml) {
		...
		if (!xml.matches($EMSIPHIORDER, this)) {
			return;
		}
