 ...
 */
public class LifeUSACopyBox extends CopyBox {
	
	public LifeUSACopyBox() {
		super();
		getOverrideAttributes().add("guidelineAnnPrem");
		getOverrideAttributes().add("guidelineSinglePrem");
	}
	
	public void doSpecificProcessing(NbaContractVO copyTo, NbaContractVO copyFrom) {
		super.doSpecificProcessing(copyTo, copyFrom);
	}
