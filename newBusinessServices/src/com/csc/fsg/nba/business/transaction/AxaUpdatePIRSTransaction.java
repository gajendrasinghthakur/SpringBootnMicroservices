 ...
 * <td>ALS4287</td><td>AXA Life Phase 2</td><td>QC #3198 - nbA did not trigger XML generation for PIRS system</td>
 * </tr>
 * </table>
 * <p>
 ...
 */
public class AxaUpdatePIRSTransaction extends AxaDataChangeTransaction {
	protected NbaLogger logger = null;
	protected static long[] changeTypes = { 
			DC_SIGNILLUS_RECEIVED,
			DC_POLDELRECEIPT_RECEIVED ,
            //APSL550 begin
			DC_PREMQUOTE_RECEIVED,
			DC_PSTAPPREQ_ADDED,
			//APSL550 end
			DC_PREMQUOTE_WAIVED //APSL1441
			};
	...
	protected NbaDst callInterface(NbaTXLife nbaTxLife, NbaUserVO user, NbaDst nbaDst) throws NbaBaseException {
		if (isCallNeeded() && nbaTxLife.isUnderwriterApproved()) {
			AxaWSInvoker webServiceInvoker = AxaWSInvokerFactory.createWebServiceRequestor(AxaWSConstants.WS_OP_PIRS, user, nbaTxLife, null, null);
			webServiceInvoker.execute();
		}
		return nbaDst;
	}
   //Code deleted ALS4827
	/* (non-Javadoc)
	...
	protected boolean isTransactionAlive() {
		return NbaUtils.isCompensationCallEnabled();
	}
