 ...
 * </thead>
 * <tr>
 * <td>NBLXA-1954</td><td>AXA Life Phase 2</td>
 * </tr>
 * </table>
 * <p>
 ...
 */
public class AxaSignificantValidationErrorTransaction extends AxaDataChangeTransaction implements NbaConstants{
	protected NbaLogger logger = null;
	
	protected static	long[] changeTypes = {
		DC_SEVERE_CV_RESOLVED
	};
	...
	protected NbaDst callInterface(NbaTXLife nbaTxLife, NbaUserVO user, NbaDst nbaDst) throws NbaBaseException {
		if (isCallNeeded() && nbaDst.isCase() && nbaDst.getQueue().equals(NbaConstants.QUEUE_APPHLD) && nbaDst.isSuspended()) {
