 ...
 * Works on all the work items sent to "Aggregate Contract 6" queue and will perform aggregation of  
...
public class NbaProcAggregateContract6 extends NbaProcAggregateContract {

	
	/**
	 * NbaProcAggregateContract6 constructor comment.
	 */
	public NbaProcAggregateContract6() {
		super();
	}
