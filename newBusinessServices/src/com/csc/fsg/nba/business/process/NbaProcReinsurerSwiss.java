...
/**
 * <code>NbaProcReinsurerSwiss</code> handles communications between nbAccelerator
 * and Swiss Re.  It extends the NbaProcReinsurerCommunications class, which drives the process,
 * and supplies Swiss Re specific functionality.
 * <p>
 ...
 */
public class NbaProcReinsurerSwiss extends NbaProcReinsurerCommunications {
	/**
	 * NbaProcReinsurerSwiss default constructor.
	 */
	public NbaProcReinsurerSwiss() {
		super();
	}
