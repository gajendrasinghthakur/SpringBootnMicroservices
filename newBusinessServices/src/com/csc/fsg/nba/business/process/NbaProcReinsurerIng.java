...
/**
 * <code>NbaProcReinsurerIng</code> handles communications between nbAccelerator
 * and ING.  It extends the NbaProcReinsurerCommunications class, which drives the process,
 * and supplies ING specific functionality.
 * <p>
 ...
 */
public class NbaProcReinsurerIng extends NbaProcReinsurerCommunications {
	/**
	 * NbaProcReinsurerIng default constructor.
	 */
	public NbaProcReinsurerIng() {
		super();
	}
	/**
	 * This method performs reinsurer specific processing as required for ING. 
	...
	/**
	 * For ING processing,  this will sets the URL (path) from the NbaConfiguration file.
	 */
