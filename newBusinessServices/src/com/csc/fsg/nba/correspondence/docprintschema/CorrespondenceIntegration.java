...
/**
 * CorrespondenceIntegration class.
 *
 */
public class CorrespondenceIntegration
	implements com.tbf.xml.XmlObject,
	com.tbf.xml.Validateable,
	java.io.Serializable {

	/**
	 * Constant for "DocPrintForms" node name.
	 */
	public static final String $DOC_PRINT_FORMS = "DocPrintForms";
	...
	/**
	 * Constant for "CorrespondenceIntegration" node name.
	 */
	public static final String $CORRESPONDENCE_INTEGRATION = "CorrespondenceIntegration";
	 ...
	 */
	protected Correspondence _Correspondence = null;
	protected DocPrintVariables _DocPrintVariables = null;
	protected DocPrintForms _DocPrintForms = null;
	 ...
	 */
	public CorrespondenceIntegration () {
	}
	 ...
	 */
	public CorrespondenceIntegration (XmlElement xml) {
		unmarshal(xml);
	}
	 ...
	 */
	public CorrespondenceIntegration (XmlElement xml, XmlObject parent) {
		_parent_ = parent;
		unmarshal(xml);
	}
	...
	/**
	 * Get the Correspondence property.
	 */
	...
	/**
	 * Set the Correspondence property.
	 */
	public void setCorrespondence (Correspondence obj) {
		_Correspondence = obj;
	}


	private void setCorrespondence (XmlElement xml) {

		_Correspondence =
			new Correspondence(xml, this);
	}
	...
	/**
	 * Checks for whether Correspondence is set or not.
	 *
	 * @return true if Correspondence is set, false if not
	 */
	 public boolean hasCorrespondence () {
		return (_Correspondence != null);
	}


	/**
	 * Discards Correspondence's value.
	 */
	...
	/**
	 * Get the DocPrintVariables property.
	 */
	public DocPrintVariables getDocPrintVariables () {
		return (_DocPrintVariables);
	}


	/**
	 * Set the DocPrintVariables property.
	 */
	public void setDocPrintVariables (DocPrintVariables obj) {
		_DocPrintVariables = obj;
	}


	private void setDocPrintVariables (XmlElement xml) {

		_DocPrintVariables =
			new DocPrintVariables(xml, this);
	}
	...
	/**
	 * Checks for whether DocPrintVariables is set or not.
	 *
	 * @return true if DocPrintVariables is set, false if not
	 */
	 public boolean hasDocPrintVariables () {
		return (_DocPrintVariables != null);
	}


	/**
	 * Discards DocPrintVariables's value.
	 */
	 public void deleteDocPrintVariables () {
		_DocPrintVariables = null;
	}


	/**
	 * Get the DocPrintForms property.
	 */
	public DocPrintForms getDocPrintForms () {
		return (_DocPrintForms);
	}


	/**
	 * Set the DocPrintForms property.
	 */
	public void setDocPrintForms (DocPrintForms obj) {
		_DocPrintForms = obj;
	}


	private void setDocPrintForms (XmlElement xml) {

		_DocPrintForms =
			new DocPrintForms(xml, this);
	}
	...
	/**
	 * Checks for whether DocPrintForms is set or not.
	 *
	 * @return true if DocPrintForms is set, false if not
	 */
	 public boolean hasDocPrintForms () {
		return (_DocPrintForms != null);
	}


	/**
	 * Discards DocPrintForms's value.
	 */
	 public void deleteDocPrintForms () {
		_DocPrintForms = null;
	}


	protected String _node_name_ = $CORRESPONDENCE_INTEGRATION;
	...
	public static String getClassXmlTagName () {
		return ($CORRESPONDENCE_INTEGRATION);
	}
	...
	transient protected static XmlValidator 
		_Correspondence_validator_ = null;
	transient protected static XmlValidator 
		_DocPrintVariables_validator_ = null;
	transient protected static XmlValidator 
		_DocPrintForms_validator_ = null;
	...
	protected static synchronized void createValidators () {
		...
		_Correspondence_validator_ = new XmlValidator(
			"CorrespondenceIntegration.Correspondence", "Element", 
			"CorrespondenceIntegration/Correspondence", 0, 1);

		_DocPrintVariables_validator_ = new XmlValidator(
			"CorrespondenceIntegration.DocPrintVariables", "Element", 
			"CorrespondenceIntegration/DocPrintVariables", 0, 1);

		_DocPrintForms_validator_ = new XmlValidator(
			"CorrespondenceIntegration.DocPrintForms", "Element", 
			"CorrespondenceIntegration/DocPrintForms", 0, 1);
	...
	public java.util.Vector getValidationErrors (
		...
		is_valid = _Correspondence_validator_.isValid(
			_Correspondence,
		...
		is_valid = _DocPrintVariables_validator_.isValid(
			_DocPrintVariables,
			errors, return_on_error, traverse);
		if (!is_valid && return_on_error) {
			return (errors);
		...
		is_valid = _DocPrintForms_validator_.isValid(
			_DocPrintForms,
			errors, return_on_error, traverse);
		if (!is_valid && return_on_error) {
			return (errors);
	...
	public static boolean matches (XmlElement xml, XmlObject parent) {
		...
		return (xml.matches($CORRESPONDENCE_INTEGRATION, nsm, parent));
	}
	 ...
	 */
	public static CorrespondenceIntegration unmarshal (
			java.io.InputStream in) throws Exception {

		CorrespondenceIntegration obj = new CorrespondenceIntegration();
	...
	public void unmarshal (XmlElement xml) {
		...
		if (!xml.matches($CORRESPONDENCE_INTEGRATION, this)) {
			return;
		}
		...
		if (xml.matches($CORRESPONDENCE,
			Correspondence.nsm, this)) {

			setCorrespondence(xml);
			xml = xml.next();
			if (xml == null) {
				return;
			}
		...
		if (xml.matches($DOC_PRINT_VARIABLES,
			DocPrintVariables.nsm, this)) {

			setDocPrintVariables(xml);
			xml = xml.next();
			if (xml == null) {
				return;
			}
		...
		if (xml.matches($DOC_PRINT_FORMS,
			DocPrintForms.nsm, this)) {

			setDocPrintForms(xml);
			xml = xml.next();
			if (xml == null) {
				return;
			}
