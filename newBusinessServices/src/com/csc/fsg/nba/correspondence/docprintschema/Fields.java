...
public class Fields
	 ...
	 */
	protected java.util.Vector _Name = new java.util.Vector(4, 0);
	 ...
	 */
	public Fields (XmlElement xml, XmlObject parent) {
		_parent_ = parent;
		unmarshal(xml);
	}
	...
	public void setName (java.util.Vector newList) {
		if (newList == null) {
			...
			_Name = new java.util.Vector();
			XmlObjectFactory.copyStrings(
				$NAME, newList, _Name);
		}
	}


	private void setName (XmlElement xml) {
		...
		while (xml != null &&
			xml.matches($NAME, this)) {

			XmlType obj = new XmlString(
				$NAME,
				xml.getData());
	...
	protected String _node_name_ = $FIELDS;
	...
	public java.util.Vector getValidationErrors (
		...
		if (_unexpected_xml_errors_ != null &&
			...
			java.util.Vector errors = 				(java.util.Vector)_unexpected_xml_errors_.clone();
			return (errors);
		}
	...
	public static boolean matches (XmlElement xml, XmlObject parent) {
		...
		return (xml.matches($FIELDS, nsm, parent));
	}
	 ...
	 */
	public static Fields unmarshal (
