...
public class Image
	 ...
	 */
	public Image (XmlElement xml, XmlObject parent) {
		_parent_ = parent;
		unmarshal(xml);
	}
	 ...
	 */
	public void setFields (Fields obj) {
		_Fields = obj;
	}


	private void setFields (XmlElement xml) {
	...
	/**
	 * Checks for whether Fields is set or not.
	 *
	 * @return true if Fields is set, false if not
	 */
	...
	protected String _node_name_ = $IMAGE;
	...
	protected static synchronized void createValidators () {
		...
		_Fields_validator_ = new XmlValidator(
			"Image.Fields", "Element", 
			"Image/Fields", 1, 1);
	...
	public java.util.Vector getValidationErrors (
		...
		is_valid = _Fields_validator_.isValid(
			_Fields,
	...
	public static boolean matches (XmlElement xml, XmlObject parent) {
		...
		return (xml.matches($IMAGE, nsm, parent));
	}
