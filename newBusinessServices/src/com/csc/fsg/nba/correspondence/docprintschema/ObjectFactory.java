...
public class ObjectFactory extends XmlObjectFactory {
	...
	static {
		...
		_default_map.put("CorrespondenceIntegration",
			"com.csc.fsg.nba.correspondence.docprintschema.CorrespondenceIntegration");
		_default_map.put("Correspondence",
			"com.csc.fsg.nba.correspondence.docprintschema.Correspondence");
		_default_map.put("DocPrintVariables",
			"com.csc.fsg.nba.correspondence.docprintschema.DocPrintVariables");
		_default_map.put("Image",
			"com.csc.fsg.nba.correspondence.docprintschema.Image");
		_default_map.put("Fields",
			"com.csc.fsg.nba.correspondence.docprintschema.Fields");
		_default_map.put("DocPrintForms",
			"com.csc.fsg.nba.correspondence.docprintschema.DocPrintForms");
		_default_map.put("Forms",
			"com.csc.fsg.nba.correspondence.docprintschema.Forms");
	}
