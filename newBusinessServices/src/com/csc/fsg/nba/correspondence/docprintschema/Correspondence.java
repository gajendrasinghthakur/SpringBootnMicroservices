...
public class Correspondence
	...
	/**
	 * Constant for "CompanyCode" node name.
	 */
	public static final String $COMPANY_CODE = "CompanyCode";

	/**
	 * Constant for "Plan" node name.
	 */
	 ...
	 */
	protected String _CompanyCode = null;
	...
	/**
	 * Set the CompanyCode property.
	 */
	public void setCompanyCode (String newValue) {
		_CompanyCode = newValue;
	}


	/**
	 * Checks for whether CompanyCode is set or not.
	 *
	 * @return true if CompanyCode is set, false if not
	 */
	 public boolean hasCompanyCode () {
		return (_CompanyCode != null);
	}


	/**
	 * Discards CompanyCode's value.
	 */
	 public void deleteCompanyCode () {
		_CompanyCode = null;
	}
	 ...
	 */
	public void setPlan (String newValue) {
		_Plan = newValue;
	}


	/**
	 * Checks for whether Plan is set or not.
	 *
	 * @return true if Plan is set, false if not
	 */
	...
	protected static synchronized void createValidators () {
		...
		_DocPrintVariables_validator_ = new XmlValidator(
			"Correspondence.DocPrintVariables", "Element", 
			"Correspondence/DocPrintVariables", 0, 1);
	...
	public void unmarshal (XmlElement xml) {
		...
		if (xml.matches($COMPANY_CODE, this)) {
			setCompanyCode(xml.getData());
			xml = xml.next();
			if (xml == null) {
				return;
			}
