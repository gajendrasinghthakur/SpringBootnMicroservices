...
public class DocPrintForms
	 ...
	 */
	public DocPrintForms (XmlElement xml) {
		unmarshal(xml);
	}
	 ...
	 */
	public DocPrintForms (XmlElement xml, XmlObject parent) {
		_parent_ = parent;
		unmarshal(xml);
	}
	 ...
	 */
	public void setForms (Forms obj) {
		_Forms = obj;
	}


	private void setForms (XmlElement xml) {
	...
	/**
	 * Checks for whether Forms is set or not.
	 *
	 * @return true if Forms is set, false if not
	 */
	...
	protected String _node_name_ = $DOC_PRINT_FORMS;
	...
	protected static synchronized void createValidators () {
		...
		_Forms_validator_ = new XmlValidator(
			"DocPrintForms.Forms", "Element", 
			"DocPrintForms/Forms", 1, 1);
	...
	public java.util.Vector getValidationErrors (
		...
		is_valid = _Forms_validator_.isValid(
			_Forms,
	...
	public static boolean matches (XmlElement xml, XmlObject parent) {
		...
		return (xml.matches($DOC_PRINT_FORMS, nsm, parent));
	}
	 ...
	 */
	public static DocPrintForms unmarshal (
			java.io.InputStream in) throws Exception {

		DocPrintForms obj = new DocPrintForms();
	...
	public void unmarshal (XmlElement xml) {
		...
		if (!xml.matches($DOC_PRINT_FORMS, this)) {
			return;
		}
