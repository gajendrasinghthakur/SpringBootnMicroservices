...
public class Data
	...
	protected java.util.ArrayList _AnyContent = new java.util.ArrayList();
	 ...
	 */
	public Data (XmlElement xml, XmlObject parent) {
		_parent_ = parent;
		unmarshal(xml);
	}
	...
	/**
	 * Get the AnyContent property.
	 */
	public java.util.ArrayList getAnyContent () {
		return (_AnyContent);
	}


	public XmlObject getAnyContentAt (int index)
			throws IndexOutOfBoundsException {
		return ((XmlObject)_AnyContent.get(index));
	}


	/**
	 * Get the count of elements in the AnyContent property.
	 */
	public int getAnyContentCount () {
		if (_AnyContent == null) {
			return (0);
		}

		return (_AnyContent.size());
	}


	/**
	 * Set the AnyContent property.
	 */
	public void setAnyContent (java.util.ArrayList newList) {

		if (newList == null) {
			_AnyContent.clear();
		} else {
			_AnyContent = (java.util.ArrayList)newList.clone();
		}
	}


	public void addAnyContent (XmlObject obj) {
		if (obj == null) {
			return;
		}
	...
	public void setAnyContentAt (XmlObject obj, int index)
			throws IndexOutOfBoundsException {
		if (obj == null) {
			return;
		}

		_AnyContent.set(index, obj);
	}


	public void removeAnyContent (XmlObject obj) {
		if (obj == null) {
			return;
		}

		_AnyContent.remove(obj);
	}


	public void removeAnyContentAt (int index)
			throws IndexOutOfBoundsException {
		_AnyContent.remove(index);
	}


	private void setAnyContent (XmlElement xml) {
	...
	protected String _node_name_ = $DATA;
	...
	protected static synchronized void createValidators () {
		...
		_AnyContent_validator_ = new XmlValidator(
			"Data.AnyContent", "ANY", 
			"", 1, -1);
	...
	public java.util.Vector getValidationErrors (
		...
		is_valid = _AnyContent_validator_.isValid(
			_AnyContent,
	...
	public static boolean matches (XmlElement xml, XmlObject parent) {
		...
		return (xml.matches($DATA, nsm, parent));
	}
