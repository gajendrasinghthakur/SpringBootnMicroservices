...
public class Extract
	 ...
	 */
	public Extract (XmlElement xml, XmlObject parent) {
		_parent_ = parent;
		unmarshal(xml);
	}
	...
	protected String _node_name_ = $EXTRACT;
	...
	public static boolean matches (XmlElement xml, XmlObject parent) {
		...
		return (xml.matches($EXTRACT, nsm, parent));
	}
	 ...
	 */
	public static Extract unmarshal (
