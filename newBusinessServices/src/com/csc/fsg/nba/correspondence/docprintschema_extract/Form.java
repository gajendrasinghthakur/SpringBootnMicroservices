...
public class Form
	 ...
	 */
	public Form (XmlElement xml, XmlObject parent) {
		_parent_ = parent;
		unmarshal(xml);
	}
	...
	protected String _node_name_ = $FORM;
	...
	protected static synchronized void createValidators () {
		...
		_Name_validator_ = new XmlStringValidator(
			"Form.Name", "Element", 
			"Form/Name", -1, -1, 1, 1);
	...
	public static boolean matches (XmlElement xml, XmlObject parent) {
		...
		return (xml.matches($FORM, nsm, parent));
	}
