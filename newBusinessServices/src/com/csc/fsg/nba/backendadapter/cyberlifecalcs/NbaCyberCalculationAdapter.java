...
/**
 * This class acts as the entry point for the CyberLife backend calculation adapter.  
 * It processes the XML holding to the host and then returns the host response in XML(holding inquiry - 203) format.
 * <br>
 ...
 */
public class NbaCyberCalculationAdapter {
	private NbaLogger logger = null;
	/**
	 * NbaCyberInforceAdapter constructor.
	 */
	public NbaCyberCalculationAdapter() {
		super();
	}
	// NBA195 code deleted
	/**
	 ...
	 */
	public NbaTXLife calculate(NbaTXLife request) throws NbaBaseException {
		//Begin NBA195
		...
		Result result = sysAccess.invoke("CyberLifeDXE/CyberCalculationAdapter", list);
