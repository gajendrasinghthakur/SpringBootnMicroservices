...
public class Requests
	 ...
	 */
	protected java.util.ArrayList _Request = new java.util.ArrayList();
	 ...
	 */
	public Requests (XmlElement xml) {
		unmarshal(xml);
	}
	 ...
	 */
	public Requests (XmlElement xml, XmlObject parent) {
		_parent_ = parent;
		unmarshal(xml);
	}
	 ...
	 */
	public java.util.ArrayList getRequest () {
		return (_Request);
	}
	...
	public Request getRequestAt (int index)
		...
		return ((Request)_Request.get(index));
	}


	/**
	 * Get the count of elements in the Request property.
	 */
	 ...
	 */
	public void setRequest (java.util.ArrayList newList) {

		if (newList == null) {
			_Request.clear();
		} else {
			_Request = (java.util.ArrayList)newList.clone();
		}
	}
	...
	public void setRequestAt (Request obj, int index)
			throws IndexOutOfBoundsException {
		if (obj == null) {
			return;
		}

		_Request.set(index, obj);
	}


	public void removeRequest (Request obj) {
		if (obj == null) {
			return;
		}
	...
	public void removeRequestAt (int index)
			throws IndexOutOfBoundsException {
		_Request.remove(index);
	}


	private void setRequest (XmlElement xml) {

		_Request.clear();
		XmlElement saved_xml = xml;

		while (xml != null &&
			Request.matches(xml, this)) {
			Object obj = new Request(xml, this);
			_Request.add(obj);
	...
	protected String _node_name_ = $REQUESTS;
	...
	protected static synchronized void createValidators () {
		...
		_Request_validator_ = new XmlValidator(
	...
	public java.util.Vector getValidationErrors (
		...
		is_valid = _Request_validator_.isValid(
			_Request,
	...
	public static boolean matches (XmlElement xml, XmlObject parent) {
		...
		return (xml.matches($REQUESTS, nsm, parent));
	}
	 ...
	 */
	public static Requests unmarshal (
