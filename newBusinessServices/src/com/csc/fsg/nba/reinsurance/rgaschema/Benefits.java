...
public class Benefits
	 ...
	 */
	protected java.util.ArrayList _Benefit = new java.util.ArrayList();
	 ...
	 */
	public Benefits (XmlElement xml) {
		unmarshal(xml);
	}
	 ...
	 */
	public Benefits (XmlElement xml, XmlObject parent) {
		_parent_ = parent;
		unmarshal(xml);
	}
	...
	/**
	 * Get the Benefit property.
	 */
	public java.util.ArrayList getBenefit () {
		return (_Benefit);
	}


	public Benefit getBenefitAt (int index)
			throws IndexOutOfBoundsException {
		return ((Benefit)_Benefit.get(index));
	}


	/**
	 * Get the count of elements in the Benefit property.
	 */
	public int getBenefitCount () {
		...
		return (_Benefit.size());
	}


	/**
	 * Set the Benefit property.
	 */
	public void setBenefit (java.util.ArrayList newList) {

		if (newList == null) {
			_Benefit.clear();
		} else {
			_Benefit = (java.util.ArrayList)newList.clone();
		}
	}


	public void addBenefit (Benefit obj) {
		if (obj == null) {
			return;
		}
	...
	public void setBenefitAt (Benefit obj, int index)
			throws IndexOutOfBoundsException {
		if (obj == null) {
			return;
		}

		_Benefit.set(index, obj);
	}


	public void removeBenefit (Benefit obj) {
		if (obj == null) {
			return;
		}
	...
	public void removeBenefitAt (int index)
			throws IndexOutOfBoundsException {
		_Benefit.remove(index);
	}


	private void setBenefit (XmlElement xml) {

		_Benefit.clear();
		XmlElement saved_xml = xml;

		while (xml != null &&
			Benefit.matches(xml, this)) {
			Object obj = new Benefit(xml, this);
			_Benefit.add(obj);
	...
	protected String _node_name_ = $BENEFITS;
	...
	protected static synchronized void createValidators () {
		...
		_Benefit_validator_ = new XmlValidator(
			"Benefits.Benefit", "Element", 
			"Benefits/Benefit", 1, -1);
	...
	public java.util.Vector getValidationErrors (
		...
		is_valid = _Benefit_validator_.isValid(
			_Benefit,
	...
	public static boolean matches (XmlElement xml, XmlObject parent) {
		...
		return (xml.matches($BENEFITS, nsm, parent));
	}
	 ...
	 */
	public static Benefits unmarshal (
