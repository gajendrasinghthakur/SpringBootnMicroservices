...
public class ObjectFactory extends XmlObjectFactory {
	...
	static {
		...
		_default_map.put("ReinsuranceCases",
			"com.csc.fsg.nba.reinsurance.rgaschema.ReinsuranceCases");
		_default_map.put("Cases",
			"com.csc.fsg.nba.reinsurance.rgaschema.Cases");
		_default_map.put("Case",
			"com.csc.fsg.nba.reinsurance.rgaschema.Case");
		_default_map.put("CedingCompany",
			"com.csc.fsg.nba.reinsurance.rgaschema.CedingCompany");
		_default_map.put("CedingAdminContact",
			"com.csc.fsg.nba.reinsurance.rgaschema.CedingAdminContact");
		_default_map.put("CedingUWContact",
			"com.csc.fsg.nba.reinsurance.rgaschema.CedingUWContact");
		_default_map.put("Applicants",
			"com.csc.fsg.nba.reinsurance.rgaschema.Applicants");
		_default_map.put("Applicant",
			"com.csc.fsg.nba.reinsurance.rgaschema.Applicant");
		_default_map.put("Benefits",
			"com.csc.fsg.nba.reinsurance.rgaschema.Benefits");
		_default_map.put("Benefit",
			"com.csc.fsg.nba.reinsurance.rgaschema.Benefit");
		_default_map.put("Documents",
			"com.csc.fsg.nba.reinsurance.rgaschema.Documents");
		_default_map.put("Document",
			"com.csc.fsg.nba.reinsurance.rgaschema.Document");
		_default_map.put("Requests",
			"com.csc.fsg.nba.reinsurance.rgaschema.Requests");
		_default_map.put("Request",
			"com.csc.fsg.nba.reinsurance.rgaschema.Request");
		_default_map.put("Reinsurer",
			"com.csc.fsg.nba.reinsurance.rgaschema.Reinsurer");
		_default_map.put("AttachedFile",
			"com.csc.fsg.nba.reinsurance.rgaschema.AttachedFile");
	}
