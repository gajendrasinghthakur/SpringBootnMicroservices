...
/**
 * CedingAdminContact class.
 *
 */
public class CedingAdminContact
	 ...
	 */
	protected java.math.BigInteger _CedingContactID = null;
	 ...
	 */
	public CedingAdminContact (XmlElement xml) {
		unmarshal(xml);
	}
	 ...
	 */
	public CedingAdminContact (XmlElement xml, XmlObject parent) {
		_parent_ = parent;
		unmarshal(xml);
	}
	 ...
	 */
	public java.math.BigInteger getCedingContactID () {
	 ...
	 */
	public void setCedingContactID (java.math.BigInteger new_value) {
		_CedingContactID = new_value;
		_format_errors.remove("CedingAdminContact.CedingContactID");
	}


	public void setCedingContactID (String new_value) {
		...
		try {
			_CedingContactID = new java.math.BigInteger(new_value);
			_format_errors.remove("CedingAdminContact.CedingContactID");
		} catch (NumberFormatException nfe) {
			_CedingContactID = null;
			XmlValidationError.addValidityFormatError(
				_format_errors, "CedingAdminContact.CedingContactID", "Attribute",
				"CedingAdminContact/CedingContactID", new_value);
		}
	}
	...
	protected String _node_name_ = $CEDING_ADMIN_CONTACT;
	...
	transient protected static XmlNumberValidator
		_CedingContactID_validator_ = null;
	...
	protected static synchronized void createValidators () {
		...
		_CedingContactID_validator_ = new XmlNumberValidator(
			"CedingAdminContact.CedingContactID", "Attribute",
			"CedingAdminContact/CedingContactID",
	...
	public java.util.Vector getValidationErrors (
		...
		e = _CedingContactID_validator_.validate(
			_CedingContactID,
			_format_errors);
		if (e != null) {
			errors.addElement(e);
	...
	public static boolean matches (XmlElement xml, XmlObject parent) {
		...
		return (xml.matches($CEDING_ADMIN_CONTACT, nsm, parent));
	}
	 ...
	 */
	public static CedingAdminContact unmarshal (
			java.io.InputStream in) throws Exception {

		CedingAdminContact obj = new CedingAdminContact();
	...
	public void unmarshal (XmlElement xml) {
		...
		if (!xml.matches($CEDING_ADMIN_CONTACT, this)) {
			return;
		}
