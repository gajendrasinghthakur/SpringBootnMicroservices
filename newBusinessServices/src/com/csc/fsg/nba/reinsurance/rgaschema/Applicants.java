...
public class Applicants
	 ...
	 */
	protected java.util.ArrayList _Applicant = new java.util.ArrayList();
	 ...
	 */
	public Applicants (XmlElement xml) {
		unmarshal(xml);
	}
	 ...
	 */
	public Applicants (XmlElement xml, XmlObject parent) {
		_parent_ = parent;
		unmarshal(xml);
	}
	 ...
	 */
	public java.util.ArrayList getApplicant () {
		return (_Applicant);
	}
	...
	public Applicant getApplicantAt (int index)
		...
		return ((Applicant)_Applicant.get(index));
	}


	/**
	 * Get the count of elements in the Applicant property.
	 */
	 ...
	 */
	public void setApplicant (java.util.ArrayList newList) {

		if (newList == null) {
			_Applicant.clear();
		} else {
			_Applicant = (java.util.ArrayList)newList.clone();
		}
	}
	...
	public void setApplicantAt (Applicant obj, int index)
			throws IndexOutOfBoundsException {
		if (obj == null) {
			return;
		}

		_Applicant.set(index, obj);
	}


	public void removeApplicant (Applicant obj) {
		if (obj == null) {
			return;
		}

		_Applicant.remove(obj);
	}


	public void removeApplicantAt (int index)
			throws IndexOutOfBoundsException {
		_Applicant.remove(index);
	}
	...
	private void setApplicant (XmlElement xml) {
		...
		while (xml != null &&
			Applicant.matches(xml, this)) {
			Object obj = new Applicant(xml, this);
			_Applicant.add(obj);
	...
	protected String _node_name_ = $APPLICANTS;
	...
	protected static synchronized void createValidators () {
		...
		_Applicant_validator_ = new XmlValidator(
			"Applicants.Applicant", "Element", 
			"Applicants/Applicant", 1, -1);
	...
	public static boolean matches (XmlElement xml, XmlObject parent) {
		...
		return (xml.matches($APPLICANTS, nsm, parent));
	}
	 ...
	 */
	public static Applicants unmarshal (
			java.io.InputStream in) throws Exception {

		Applicants obj = new Applicants();
	...
	public void unmarshal (XmlElement xml) {
		...
		if (!xml.matches($APPLICANTS, this)) {
			return;
		}
