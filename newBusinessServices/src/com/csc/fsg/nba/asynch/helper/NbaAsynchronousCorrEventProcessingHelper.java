...
/**
 * NbaAsynchronousCorrEventProcessingHelper
 * <p>
...
public class NbaAsynchronousCorrEventProcessingHelper extends AsynchronousTransactionHelper {
     ...
     * 
     */
    public NbaAsynchronousCorrEventProcessingHelper(NbaTXLife _nbaTXLife, NbaDst _nbaDst, NbaUserVO _user) {
    ...
    public void run() {
		try {//ALS5535
			...
			e.printStackTrace(System.err);  //ALS5535
		}
