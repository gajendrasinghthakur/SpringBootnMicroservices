...
/**
 * NbaAsynchContractValidationHelper
 * <p>
 ...
 */
public class NbaAsynchContractValidationHelper extends AsynchronousTransactionHelper {
      ...
      * 
      */
     public NbaAsynchContractValidationHelper(NbaTXLife _nbaTXLife,NbaDst _nbaDst,NbaUserVO _user) {
    ...
    public void run() {
        try {
            new NbaContractValidation().validate(nbaTXLife, nbaDst, user); //NBA064
