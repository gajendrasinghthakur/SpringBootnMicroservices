...
public class CheckDataStoreForHoldingBP extends NewBusinessAccelBP {
    ...
    public Result process(Object input) {
        ...
        try {
            if (input instanceof NbaTXLife) {
            	boolean res = NbaServerUtility.isDataStoreDB((NbaTXLife)input);
            	result.addResult((res ? Boolean.TRUE : Boolean.FALSE));
            }
        } catch (Exception e) {
