...
/**
 * Retrieves the Letters for the Correspondence System.
 * Accepts a <code>NbaCorrespondenceRequestVO</code> as input to create a correspondence extract
 * The category , dst,  and NbaUserVO  are required on the value object.
...
public class RetrieveLettersBP extends NewBusinessAccelBP {
	...
	public Result process(Object input) {
		...
		try {
			...
			result.addResult(adapter.getLetterNames(corrRequestVO.getCategory()));
		} catch (Exception e) {
