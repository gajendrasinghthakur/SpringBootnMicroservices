...
/**
 * Reprints specified contract print documents as specified in the required input, a 
...
public class ReprintContractBP extends NewBusinessAccelBP {
	...
	public Result process(Object input) {
		...
		try {
			...
			cpf.reprintContract(req.user, req.aCase, req.content);
		} catch (Exception e) {
