package com.csc.fs.accel.ACORD.assembler;
 ...
 */
public class TX188LifeAssembler extends AccelTransformation {
	...
	protected static final String PROVIDER_ID = "BT"; 
	...
	public Result disassemble(Object request) throws RuntimeException {
		...
		if (request instanceof WebServiceCall) {
			...
			transdo.setPayload(removePrefixFromRequest(((WebServiceCall) request).getPayload(),PROVIDER_ID));
	...
	//APSL5203 New Method
	/**
	 * @purpose This method will remove the prefix from the request
	 * @param scorResponse
	 * @param providerID
	 * @return
	 */
		protected static String removePrefixFromRequest(String scorResponse,String providerID) {
